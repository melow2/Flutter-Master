...
class _$Person extends Person {
  ...
  _$Person._({this.id, this.emoji, this.name, this.bio}) : super._() {
    ...
    BuiltValueNullFieldError.checkNotNull(emoji, 'Person', 'emoji');
    BuiltValueNullFieldError.checkNotNull(name, 'Person', 'name');
    BuiltValueNullFieldError.checkNotNull(bio, 'Person', 'bio');
  }
  ...
  _$Person build() {
    final _$result = _$v ??
        new _$Person._(
            ...
            bio: BuiltValueNullFieldError.checkNotNull(bio, 'Person', 'bio'));
    replace(_$result);
    return _$result;
  }
}
